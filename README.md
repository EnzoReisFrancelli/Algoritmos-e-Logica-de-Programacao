...
Este repositório contém **exercícios e exemplos práticos de lógica de programação**, desenvolvidos em **Portugol, linguagem C, linguagem C++, linguagem JAVA e linguagem C# (POR ENQUANTO)**, com foco no aprendizado dos conceitos fundamentais da programação feitos durante o curso de Algoritmos e Lógica de Programação (Udemy Academy).
